    ...
    def train_agent(self):
        ...
        for epoch in range(self.epochs):
            ...
            for k in range(self.k):
                ...
                td_target     = td_target + data.rewards.flatten() + (1.0/k) * (self.gamma * target_max * (1 - data.dones.flatten()))

                current_value_ = q_network(data.observations).squeeze(0)
                current_value  = current_value + (1.0/k) * (current_value_.gather(1, data.actions).squeeze().unsqueeze(0))
            ...
            while True :
                ...
                if random.random() < epsilon :
                    ...
                    for k in range(self.k):
                        ...
                        e_values  = q_values + (1.0/k)*q_values_
